                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-shrink-0">
                      <button
                        ...
                        className="px-2 py-2.5 border border-gray-300 rounded-xl bg-white hover:bg-gray-50 flex items-center gap-1 text-sm font-medium w-[90px]"
                        dir="ltr"
                      >
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="flex-1 min-w-0 px-3 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none"
