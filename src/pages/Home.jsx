...
const QuickAction = ({ to, icon, title, gradient, delay = 0 }) => (
    ...
    <div className="group relative">
      ...
      <div className={clsx(
        ...
        <div className="relative flex flex-col items-center gap-2 text-center">
          ...
          <span className="text-xs font-semibold text-gray-700 leading-tight group-hover:text-gray-900 transition-colors">{title}</span>
        </div>
      </div>
    </div>
  </Link>
...
const ExtraServiceCard = ({ to, icon: Icon, title, description, gradient }) => (
          ...
          <div className="px-4 mb-6">
            ...
            {activeTab === 'quick' && (
              <div className="grid grid-cols-4 gap-2.5">
                <QuickAction to="/exhibitors" icon="/media/PNG/App Icons-02.png" title="Exhibitors" delay={0} />
                <QuickAction to="/speakers" icon="/media/PNG/App Icons-11.png" title="Speakers" delay={50} />
                ...
                <QuickAction to="/navigation" icon="/media/PNG/App Icons-03.png" title="Navigate" delay={350} />
              </div>
            )}
