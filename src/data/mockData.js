...
export const newsItems = [
  {
    ...
    title_ar: "النجم السعيد تنضم إلى معرض ليبيا البناء بنغازي كراعي للمعدات الثقيلة",
    ...
    summary_ar: "النجم السعيد هي شركة راسخة توفر حلول المعدات الثقيلة لمشاريع البناء والبنية التحتية واسعة النطاق في جميع أنحاء ليبيا.",
    content: "We are proud to welcome Al Najm Alssaed as our Heavy Equipment Sponsor for Libya Build Benghazi 2026.",
    content_ar: "يسعدنا الترحيب بشركة النجم السعيد كراعي للمعدات الثقيلة في معرض ليبيا البناء بنغازي 2026.",
  ...
  },
  {
    ...
    title_ar: "شركة إيثار تُعلن كراعي لأنظمة التكييف في معرض ليبيا البناء بنغازي 2026",
    ...
    summary_ar: "شركة إيثار هي مزود معترف به لحلول التكييف والأجهزة المنزلية في ليبيا والوكيل الحصري لشركة Hisense في السوق المحلي.",
    content: "We are delighted to announce Eithar Company's partnership as HVAC Sponsor for Libya Build Benghazi 2026.",
    content_ar: "يسعدنا الإعلان عن شراكة شركة إيثار كراعي لأنظمة التكييف في معرض ليبيا البناء بنغازي 2026.",
    date: "2026-01-20T18:00:00",
    category: "Sponsorship",
    priority: "high",
  ...
  },
  {
    ...
    title_ar: "معرض ليبيا البناء بنغازي 2026 يرحب بشركة سيليني كراعي للدهانات",
    ...
    summary_ar: "شركة سيليني هي الوكيل الحصري لدهانات Scib في ليبيا، وتوفر حلول طلاء عالية الجودة للمشاريع السكنية والتجارية.",
    content: "We are excited to welcome Silini Company as our Paints Sponsor for Libya Build Benghazi 2026.",
    content_ar: "يسعدنا الترحيب بشركة سيليني كراعي للدهانات في معرض ليبيا البناء بنغازي 2026.",
    date: "2026-01-20T18:00:00",
    category: "Sponsorship",
    priority: "high",
